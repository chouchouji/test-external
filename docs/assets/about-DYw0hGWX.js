...
const TestComponent = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup() {
    ...
    return () => Vue.createVNode("div", null, [Vue.createVNode("h1", null, [Vue.createTextVNode("Hello, Vue with JSX!")]), Vue.createVNode("p", null, [Vue.createTextVNode("This is a simple component using JSX in Vue.js")])]);
  }
});
