...
function _sfc_render$5(_ctx, _cache) {
  return (
    Vue.openBlock(),
    Vue.createElementBlock('div', _hoisted_1$6, [
      Vue.createElementVNode('i', null, [Vue.renderSlot(_ctx.$slots, 'icon', {}, void 0, true)]),
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [
  ['render', _sfc_render$5],
  ['__scopeId', 'data-v-65db9f60']
])
const _sfc_main$6 = {}
const _hoisted_1$5 = {
        ...
        Vue.createElementBlock(
          ...
          [
            Vue.createVNode(WelcomeItem, null, {
              icon: Vue.withCtx(() => [Vue.createVNode(DocumentationIcon)]),
              heading: Vue.withCtx(() => [Vue.createTextVNode('Documentation')]),
              _: 1
            }),
            Vue.createVNode(WelcomeItem, null, {
              icon: Vue.withCtx(() => [Vue.createVNode(ToolingIcon)]),
              heading: Vue.withCtx(() => [Vue.createTextVNode('Tooling')]),
              _: 1
            }),
            Vue.createVNode(WelcomeItem, null, {
              icon: Vue.withCtx(() => [Vue.createVNode(EcosystemIcon)]),
              heading: Vue.withCtx(() => [Vue.createTextVNode('Ecosystem')]),
              _: 1
            }),
            Vue.createVNode(WelcomeItem, null, {
              icon: Vue.withCtx(() => [Vue.createVNode(CommunityIcon)]),
              heading: Vue.withCtx(() => [Vue.createTextVNode('Community')]),
              _: 1
            }),
            Vue.createVNode(WelcomeItem, null, {
              icon: Vue.withCtx(() => [Vue.createVNode(SupportIcon)]),
    ...
    return (_ctx, _cache) => {
      return (
        ...
        Vue.createElementBlock(
          ...
          null,
          [
            Vue.unref(isNotEmptyArray)(arr.value)
              ? (Vue.openBlock(), Vue.createElementBlock('h1', _hoisted_1, 'hhhhh'))
            ...
            Vue.createVNode(
              ...
              {
                default: Vue.withCtx(() => [Vue.createTextVNode('go to about page')]),
                _: 1
              }
            ),
            _hoisted_2,
            ...
            Vue.createElementVNode('main', null, [Vue.createVNode(_sfc_main$1)])
          ],
          64
        )
      )
