...
var classes$3 = (...classes2) =>
  classes2.map((className) => {
...
function useParent(key) {
  ...
  const _a = provider,
    { childInstances, collect, clear } = _a,
    parentProvider = __objRest(_a, ['childInstances', 'collect', 'clear'])
...
function updated$1(el, binding) {
  ...
  const diff =
    newBinding.color !== ((_c = el._ripple) == null ? void 0 : _c.color) ||
    newBinding.disabled !== ((_d = el._ripple) == null ? void 0 : _d.disabled)
  if (diff) {
    ...
    Vue.createElementBlock(
      'div',
      {
        class: Vue.normalizeClass(
          _ctx.classes(
            _ctx.n(),
            [_ctx.hovering, _ctx.n('--hovering')],
            [_ctx.focusing && !_ctx.inMobile(), _ctx.n('--focusing')]
          )
        )
      },
      null,
          ...
          ? (Vue.openBlock(),
            Vue.createElementBlock(
              'div',
              {
                key: 0,
                class: Vue.normalizeClass(
                  _ctx.classes(_ctx.n('content'), [_ctx.loading, _ctx.n('content--active')])
                )
              },
              [
          ...
          ? (Vue.openBlock(),
            Vue.createElementBlock(
              'div',
              {
                key: 1,
                class: Vue.normalizeClass(
                  _ctx.classes(_ctx.n('$--box'), _ctx.n('body'), [
                    _ctx.$slots.default,
                    _ctx.n('inside')
                  ])
                )
                            ...
                            ? (Vue.openBlock(),
                              Vue.createElementBlock(
                                'div',
                                {
                                  key: 0,
                                  class: Vue.normalizeClass(
                                    _ctx.classes(_ctx.n(key), _ctx.n(`${key}--${_ctx.size}`))
                                  )
                                },
                                [
                                  (Vue.openBlock(true),
                  ...
                  ? (Vue.openBlock(),
                    Vue.createElementBlock(
                      'div',
                      {
                        key: 1,
                        class: Vue.normalizeClass(
                          _ctx.classes(_ctx.n('description'), _ctx.n(`description--${_ctx.size}`))
                        ),
  ...
  return Vue.withDirectives(
    ...
    Vue.createElementBlock(
      'button',
      {
        ...
        onTouchstart:
          _cache[1] ||
          (_cache[1] = (...args) => _ctx.handleTouchstart && _ctx.handleTouchstart(...args)),
        onFocus:
          _cache[2] || (_cache[2] = (...args) => _ctx.handleFocus && _ctx.handleFocus(...args)),
      ...
      [
        ...
        Vue.createElementVNode(
          ...
          {
            class: Vue.normalizeClass(
              _ctx.classes(_ctx.n('content'), [_ctx.loading || _ctx.pending, _ctx.n('--hidden')])
            )
          },
          [Vue.renderSlot(_ctx.$slots, 'default')],
          2
    ...
    [
      [
        _directive_ripple,
        { disabled: _ctx.disabled || !_ctx.ripple || _ctx.loading || _ctx.pending }
      ],
